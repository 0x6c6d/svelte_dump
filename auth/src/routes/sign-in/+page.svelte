...
<div class="flex flex-col items-center space-y-4 max-w-sm mx-auto mt-20">
  <h2 class="text-xl font-bold mb-5 text-left w-full">Sign in to Miri</h2>
  ...
  <div class="flex items-center w-full">
    ...
    <span class="px-2 text-gray-500">or sign in with email</span>
    <hr class="flex-grow border-gray-300" />
  </div>
  ...
  <p class="font-light text-s">
    Don't have an account? <a class="underline" href="/sign-up">Sign up</a>
  </p>
</div>
